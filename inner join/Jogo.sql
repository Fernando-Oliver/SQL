...
INSERT INTO tb_classe(nivel, classe, habilidade, arma)VALUES(200,"Mago","Resistencia a Magia","Cajado");
...
SELECT * FROM tb_classeINNER JOIN tb_personagem on tb_personagem.classe_id = tb_classe.id
WHERE classe_id = 3;